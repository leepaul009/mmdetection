...
# load_from = 'data/cascade_mask_rcnn_x101_32x4d_fpn_mstrain_3x_coco_20210706_225234-40773067.pth'
# load_from = 'work_dirs/ped/mask/norm/epoch_1.pth'
# load_from = 'work_dirs/ped/mask/norm_/epoch_12.pth'
load_from = 'work_dirs/ped/mask/norm_ped/epoch_12.pth'
# resume_from = ''
...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            scales=[8],
            ratios=[1.0, 2.0, 3.0], # [0.5, 1.0, 2.0],
