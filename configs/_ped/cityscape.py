...
classes = ('person',) # ('Pedestrian','Cyclist','Car','Truck','Van')
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(2048, 768), (2048, 896)], keep_ratio=True),
...
load_from = 'work_dirs/ped/hrnet_cascade_box/norm2/epoch_10.pth'
# load_from = 'work_dirs/ped/hrnet_cascade_box/norm2/latest.pth'
# resume_from = ''
    ...
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                ...
                ignore_iof_thr=0.7), # ignore_iof_thr=-1), ###
            sampler=dict(
                type='RandomSampler',
                num=256,
                pos_fraction=0.5,
